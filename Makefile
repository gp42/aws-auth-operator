...
# ops42.org/aws-auth-operator-bundle:$VERSION and ops42.org/aws-auth-operator-catalog:$VERSION.
...
test: manifests generate fmt vet ## Run tests.
	...
	source ${ENVTEST_ASSETS_DIR}/setup-envtest.sh; fetch_envtest_tools $(ENVTEST_ASSETS_DIR); setup_envtest_env $(ENVTEST_ASSETS_DIR); go test ./... -v -ginkgo.v -coverprofile cover.out
